...
GetSubscriptionOffsetRequest::GetSubscriptionOffsetRequest(
...
std::string GetSubscriptionOffsetRequest::SerializePayload() const
{
...
std::string GetSubscriptionOffsetRequest::BuildPath() const
{
    std::string path;
