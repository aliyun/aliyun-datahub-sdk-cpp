...
AppendConnectorFieldRequest::AppendConnectorFieldRequest(
...
std::string AppendConnectorFieldRequest::BuildPath() const
{
    std::string path;
...
std::string AppendConnectorFieldRequest::SerializePayload() const
{
