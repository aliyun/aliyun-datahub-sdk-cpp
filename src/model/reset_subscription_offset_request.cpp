...
ResetSubscriptionOffsetRequest::ResetSubscriptionOffsetRequest(
...
std::string ResetSubscriptionOffsetRequest::BuildPath() const
{
    std::string path;
...
std::string ResetSubscriptionOffsetRequest::SerializePayload() const
{
